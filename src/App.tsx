        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <img src="/LogoTallerTracker.png" alt="TallerTracker Logo" className="mx-auto mb-4 w-24 h-24" />
        ...
        <div className="pb-20">
          ...
          <header className="bg-white shadow-sm border-b sticky top-0 z-10">
            <div className="px-4 py-3 flex justify-start items-center gap-4">
              <img src="/LogoTallerTracker.png" alt="TallerTracker Logo" className="w-12 h-12" />
